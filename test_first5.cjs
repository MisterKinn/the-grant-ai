...
(async () => {
    ...
    // Test placeholder #4 and #5 (index 3-4)
    ...
    console.log("Replaced:", placeholders.slice(0, 5));
    ...
    fs.writeFileSync("/Users/kinn/Downloads/test26_first5.hwpx", out26);
    console.log("Saved: ~/Downloads/test26_first5.hwpx");
})();
