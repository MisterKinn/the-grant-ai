...
(async () => {
    ...
    console.log("All placeholders (first 20):", placeholders.slice(0, 20));
    ...
    fs.writeFileSync("/Users/kinn/Downloads/test26_real9.hwpx", out26);
    console.log("Saved: ~/Downloads/test26_real9.hwpx");
})();
